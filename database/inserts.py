...
def insert_into_menu(reset_table=False):
    ...
    db.add_item('Tortilla Chips & Guacamole', tortilla_chips_guacamole, 'Starters', 6.00, 200, True,'None', 'Tortilla chips topped with jack cheese, roasted salsa, jalapeño cream cheese, sour cream and our famous guacamole.')
    ...
    db.add_item('Poblano Chicken', poblano_chicken, 'Mains', 14.50, 350, False, 'None', 'Grilled chicken breast topped with red salsa, poblano chilli peppers, melted jack cheese, served with seasoned rice.')
    ...
    db.add_item("Apple Juice", default_image, "Soft Drinks", 4.00, 30, None, None, None)
    ...
    #Kids Menu
    db.add_item('Beef Taco Cups', beef_taco_cups, 'Kids', 7.00, 378, False, 'Soft taco cups layered with minced beef, sliced bell peppers, jalapeños, jack cheese, sour cream and tomatoes.')
    db.add_item('Nacho Mac and Cheese', mac_and_cheese, 'Kids', 6.00, 346, False, 'Cheese', 'A classic macaroni and cheese dish, made with parmesan and chedder cheese.')
    db.add_item('Chicken Nuggets and Wedges', chicken_nuggets, 'Kids', 6.00, 280, False, 'Air-fried chicken nuggets with a side of lightly spiced wedges, served with our chef-prepared tomato ketchup.')
    ...
    db.add_item('Chicken and Bean Burritos', bean_burritos, 'Kids', 5.50, 253, False, 'Toasted tortilla wrap with a filling of white rice, black turtle beans, red bell peppers, cheese and 100% chicken breast.')
    db.add_item('Mini Quesadillas', quesadillas, 'Kids', 6.00, 320, False, 'Cheese', 'Milk', 'Oaxaca cheese and mozarella filled tortilla wraps, toasted and served with a sour cream.')
