...
def insert_into_menu(reset_table=False):
    ...
    db.add_item('Southwest Spring Rolls', default_image,'Starters', 7.00, 239, True, 'Cheese', 'Chipotle Mexican chicken, peppers & jack cheese folded in a flour tortilla, deep fried & served with our famous guacamole.')
    ...
    db.add_item('Beef Carnitas Enchilada', default_image, 'Mains', 14.50, 410, False, 'None', 'olled flour or white corn tortillas (GF) filled with jack cheese, poblano chilli peppers and topped with creamy salsa, jalapeños & cheese. Oven baked and served over a bed of Mexican rice & our famous guacamole.')
    ...
    #Desserts
    db.add_item('Ice Cream', default_image, 'Desserts', 4.00, 145, False, 'Milk', 'Two scoops, choose from vanilla, strawberry, chocolate or toffee.')
